/*
  ...
  1. Changes
    ...
    - Update RLS policies to allow authenticated users to manage broker contact info

  2. Security
    - Maintain existing RLS policies
    - Ensure broker contact info is protected by RLS
*/

-- Add broker contact fields if they don't exist
DO $$
BEGIN
  IF NOT EXISTS (
